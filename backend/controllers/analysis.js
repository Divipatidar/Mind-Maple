...
const doAnalysis = async (req, res) => {
  try {
    ...
    console.log("userid do anlysis ----", userId);
    ...
    console.log("do analysis error", error);
...
const getAnalysis = async (req, res) => {
  try {
    ...
    console.log("userid get anlysis in catch  ----", req.userId, error);
    res.status(500).json({ msg: "Internal Server Error" });
  }
};
